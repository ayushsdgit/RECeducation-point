						...
						<div class="swiper-slide dark">
							<div class="container clearfix">
								<div class="slider-caption slider-caption-center">
									<h2 data-caption-animate="fadeInUp">We are RECians</h2>
									<p data-caption-animate="fadeInUp" data-caption-delay="200"></p>
								</div>
							</div>
							<div class="video-wrap">
								<img src="images\slider\Slide11.jpg">
					...
					<div class="row clearfix">
						...
						<div class="col-lg-5">
							<div class="heading-block topmargin">
								<h1>Welcome to REC education <br>Point</h1>
							</div>
							<p class="lead">We are a group of RECeducation point; our aim is to promote education. If you are a student, then contact us to secure your future. We deliver free international standard video lectures and content. We are also providing services in Web &amp; Software Development.</p>
						</div>
				...
				<div class="container clearfix" id="features">
					...
					<div class="row topmargin-lg bottommargin-sm">
						...
						<div class="col-md-4 hidden-sm bottommargin center">
							<img src="images/services/iphone7.jpg" alt="iphone 2">
						</div>
